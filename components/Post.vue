<template>
  <article class="md:flex">
    ...
    <div class="content-block">
      ...
      <badge :label="`${content.version}`" class="absolute -top-6 right-0 md:static mb-4" />
      <h1 v-if="content.title" class="text-base sm:text-xl font-bold mb-4">
        {{ content.title }}
      </h1>
...
.content-date {
  @apply pl-7 text-xs sm:text-sm leading-6 text-slate-500 md:w-1/6 md:pl-0 md:pr-12 md:text-right;
}
.content-block {
