<template>
  <main class="min-h-screen bg-white">
    <header class="py-4 px-2.5 sticky top-0 z-50 bg-white bg-opacity-50 backdrop-blur border-b border-slate-100">
    ...
    <section class="min-h-[calc(100vh-102px)] pt-4">
      <div class="relative mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 overflow-hidden">
    ...
    >
      <a class="text-gray-500" href="https://github.com/fayazara/logspot" target="_blank"> Powered by logspot </a>
      <a class="text-primary" href="https://github.com/fayazara/logspot" target="_blank"> See all updates </a>
    </footer>
  </main>
</template>
